...
class IndexNodeClient implements \IndexNodeIf {
  ...
  {
    $args = new \IndexNode_search_args();
  ...
  public function recv_search()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\IndexNode_search_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \IndexNode_search_result();
  ...
  {
    $args = new \IndexNode_deleteByQuery_args();
    $args->partitionId = $partitionId;
    $args->query = $query;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\IndexNode_deleteByQuery_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \IndexNode_deleteByQuery_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    return;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\IndexNode_index_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \IndexNode_index_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->e !== null) {
  ...
  {
    $args = new \IndexNode_createPartition_args();
    $args->partitionId = $partitionId;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\IndexNode_createPartition_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \IndexNode_createPartition_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->partex !== null) {
  ...
  {
    $args = new \IndexNode_removePartition_args();
    $args->partitionId = $partitionId;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\IndexNode_removePartition_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \IndexNode_removePartition_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->partex !== null) {
  ...
  {
    $args = new \IndexNode_containsPartition_args();
    $args->partitionId = $partitionId;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\IndexNode_containsPartition_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \IndexNode_containsPartition_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'partex',
          'type' => TType::STRUCT,
          'class' => '\NonExistentPartitionException',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parsex = new \ParseException();
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->partex = new \NonExistentPartitionException();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->e = new \NonExistentPartitionException();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->partex = new \PartitionAlreadyExistsException();
            $xfer += $this->partex->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
